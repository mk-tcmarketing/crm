 ...
 */
final class Version20200416104950 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE appel DROP emit_at');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE appel ADD emit_at DATETIME DEFAULT \'current_timestamp()\'');
