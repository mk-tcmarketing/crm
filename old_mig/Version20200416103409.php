 ...
 */
final class Version20200416103409 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE appel (id INT AUTO_INCREMENT NOT NULL, client_id INT NOT NULL, emit_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, repense VARCHAR(255) NOT NULL, INDEX IDX_130D3BD19EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE appel ADD CONSTRAINT FK_130D3BD19EB6921 FOREIGN KEY (client_id) REFERENCES client (id)');
