 ...
 */
final class Version20200416122715 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE rendez_vous CHANGE appel_id appel_id INT DEFAULT NULL, CHANGE date date DATETIME DEFAULT NULL');
