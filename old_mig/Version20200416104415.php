 ...
 */
final class Version20200416104415 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE appel CHANGE emit_at emit_at DATETIME DEFAULT CURRENT_TIMESTAMP');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE appel CHANGE emit_at emit_at DATETIME DEFAULT \'current_timestamp()\' NOT NULL');
