 ...
 */
final class Version20200416121955 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE rendez_vous ADD appel_id_id INT DEFAULT NULL, DROP rendezvous_id, CHANGE date date DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE rendez_vous ADD CONSTRAINT FK_65E8AA0A6C94E57F FOREIGN KEY (appel_id_id) REFERENCES appel (id)');
        $this->addSql('CREATE INDEX IDX_65E8AA0A6C94E57F ON rendez_vous (appel_id_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE rendez_vous DROP FOREIGN KEY FK_65E8AA0A6C94E57F');
        $this->addSql('DROP INDEX IDX_65E8AA0A6C94E57F ON rendez_vous');
        $this->addSql('ALTER TABLE rendez_vous ADD rendezvous_id INT DEFAULT NULL, DROP appel_id_id, CHANGE date date DATETIME DEFAULT \'NULL\'');
