 ...
 */
final class Version20200416122431 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE rendez_vous DROP appel_id_id, CHANGE date date DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE rendez_vous ADD appel_id_id INT DEFAULT NULL, CHANGE date date DATETIME DEFAULT \'NULL\'');
