 ...
 */
final class Version20200416125341 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE appel_rendez_vous (appel_id INT NOT NULL, rendez_vous_id INT NOT NULL, INDEX IDX_3821583F91EF7EAA (rendez_vous_id), INDEX IDX_3821583F270B0E02 (appel_id), PRIMARY KEY(appel_id, rendez_vous_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
