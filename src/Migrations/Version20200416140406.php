 ...
 */
final class Version20200416140406 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE devis DROP referance');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE devis ADD referance VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE rendez_vous CHANGE date date DATETIME DEFAULT \'NULL\'');
